...
\begin{center}
    \begin{tikzpicture}[scale=0.75, every node/.style={scale=0.75}]
        ...
        \node (prep) [preparation, below of = start, yshift = -5mm] {\texttt{String typeOfWaste, colour;}};
        ...
        \node (invalid) [data, right of = branch-3, xshift = 1cm, yshift = -5.25cm] {Output "invalid waste type"};
        ...
        \node (end) [terminator, below of = output, align=center, minimum width=2.5cm, minimum height=2.5em, yshift = -0.5cm] {End};
        \draw [connector] (start) -- (prep);
        \draw [connector] (prep) -- (input-1);
